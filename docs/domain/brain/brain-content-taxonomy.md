...
人間関係については現時点で独立した型を増やしません。たとえば、パートナーとの出来事や、本人が明言した相手についての観察はMemory、関係で大切にすることはValue、相手への約束はGoal、越えてほしくない線はDecision System内のConstraintとして分類できます。相手についての観察は、その相手の客観的な人物像ではなく「本人がその時点でそう捉えていた」という本人所有の記憶として扱います。
...
Semantic Memoryには「パートナーは対立すると一度黙って考える」「母は土日が休み」のように、本人が特定の相手について明言した観察も含められます。この場合も、AIが相手の性格や勤務事情を推定して補完せず、本人の表現、対象人物、観測時点、Evidenceを保持します。助言へ使うときは、現在も同じ人物・状況を指すと確認できる範囲に限り、相手本人が確認した事実とは扱いません。
