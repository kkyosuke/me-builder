...
アンケート一覧、回答、回答内容、LINE通知、リッチメニューの詳細なUIと遷移は[Phase 1 アンケート体験設計](../questionnaire/questionnaire-experience.md)を正とします。
...
Question、Survey、SurveyResponseの集約、状態、不変条件と、回答をSource Recordとして扱う関係は[Phase 1 アンケートドメイン設計](../questionnaire/questionnaire-domain-design.md)を正とします。
