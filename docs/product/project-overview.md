...
LIFFと将来のSSOを各機能から分離し、同じAccountとアプリケーションセッションへ収束させる技術境界は[Web認証・アプリケーションセッション設計](../architecture/web-authentication-design.md)を正とします。SSO製品と追加時期はこの文書では決定しません。
