...
「わたしのまとめ」は生成回数をPlanの価値差にしません。診断または日記があり、前回の版から入力や必要な生成形式が変わった場合、または前回生成から30日以上経過した場合に、どのPlanでも新しい版を生成できます。連続実行と予期しない原価を抑える運用上限は全Plan共通で1 Accountあたり月12回とし、価格表の差別化項目として訴求しません。
