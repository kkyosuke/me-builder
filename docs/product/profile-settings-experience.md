...
- 「あなたのデータ」から、診断回答と日記の確認・訂正・削除画面を開く
...
- 診断回答と日記の確認・訂正・削除画面への導線とプロフィールへの復帰
...
- 入力データ画面にJSONエクスポートやダウンロード操作を表示しない
