...
アバター画像のアップロード、プレビュー、保存、削除は[アバター設定体験設計](avatar-experience.md)、Web全体での画面接続は[全体画面遷移設計](screen-navigation.md)を正とします。
...
- アバター行には現在値を表示し、アバター自体から画像選択・保存モーダルを開く
...
プロフィールのアバター行には、現在のアバターまたは未設定のプレースホルダーを表示します。画像の選択、プレビュー、保存、削除はプロフィール画面へ直接展開せず、[アバター設定体験設計](avatar-experience.md)が所有するモーダルで行います。保存成功後は現在値を即時反映します。
...
- アバター機能はAccount所有の画像を担当し、詳細はアバター設計へ閉じる
