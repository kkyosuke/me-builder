...
ユーザーが話を広げたくなさそうな場合は、「そっか、おつかれさま」で終えてよく、記録のために質問を続けません。
...
この文書の目標体験は、[プロジェクト概要 §11](project-overview.md#11-段階的な進め方)におけるPhase 3の「自分とのチャット」を、日々の日記入力と接続したものです。一度に全機能を提供せず、次の順で成立させます。

| 段階 | 提供する体験 |
| --- | --- |
| Phase 1 | 本人がLINEへ送った日記を原文のままSource Recordとして蓄積する。入力から蓄積までAIを使わない |
| Phase 2 | Source Recordから記憶・行動原理の候補を導出し、本人が確認・修正・却下できるようにする |
| Phase 3 | 「今日はどうだった？」から始まる対話、過去との共通点の提示、確認済み情報を使った助言を提供する |

Phase 2で本人確認の体験が成立する前に、未確認の推定だけで「本人らしい助言」を返しません。
