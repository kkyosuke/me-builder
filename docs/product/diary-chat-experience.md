...
1つのSessionで属性確認のためだけに行う質問は最大1つとし、日記の記録ゴールや本人が話したい内容を中断してまで尋ねません。質問への回答がなければ、同じSessionや次の声かけで言い換えて追いかけません。
...
- 声かけコンテキストを一括質問せず、現在の話に手がかりがある場合だけ、1つのSessionにつき最大1件を確認できる
