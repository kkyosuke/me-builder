...
- Webは、診断への回答、個別の回答結果、相性、わたしのまとめ、プロフィール設定、セルフケア情報、AI相談を担当する
- Webの主ナビゲーションは、左から「わたし」「診断」「相性」の3項目にする
- プロフィールは主ナビゲーションへ追加せず、本人確認後の一般利用者向け画面の共通ヘッダー右上から開く
- AI相談は主ナビゲーションへ独立した項目を増やさず、「わたしのまとめ」または「わたしのセルフケア」から文脈付きで開く
...
「わたしのまとめ」は、診断結果の閲覧、次の診断、セルフケア、AI相談を接続する本人向けのハブです。ただし、MCP接続管理や公開範囲など画面設計が未確定の機能を、この図だけで新しい遷移先として確定しません。特徴取得はAPIだけを提供し、UI導線を設けません。
...
| 診断 | 個別の回答結果 | 回答完了、回答済み診断、わたしのまとめ | 診断回答、診断一覧、わたしのまとめ |
...
| わたし | わたしのまとめ | リッチメニュー、主ナビゲーション、個別の回答結果 | 個別の回答結果、診断一覧、セルフケア、AI相談 |
| わたし | わたしのセルフケア | わたしのまとめ | わたしのまとめ、AI相談 |
