...
この文書は、me-builderの利用者がLINEとWebを行き来し、日記、診断、相性、自分の傾向、セルフケア、AI相談へ到達するまでの全体画面遷移を定義します。チャネルをまたぐ入口、Webの主ナビゲーション、各画面の接続、認証後の復帰先、共通の例外遷移、および一般利用者と管理者の画面分離を所有します。
...
- Webは、診断への回答、個別の回答結果、相性、自分の傾向、セルフケア情報、AI相談を担当する
- Webの主ナビゲーションは「診断」「相性」「わたし」の3項目にする
...
Webの一般利用者向け画面では、次の3項目を同じ位置に表示します。
