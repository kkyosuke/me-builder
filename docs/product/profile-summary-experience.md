...
本人の現在のアバターと変更操作を表示します。未設定時の表示、設定画面への導線、生成中・候補完成時の案内は[アバター設定体験設計](avatar-experience.md)を正とします。
