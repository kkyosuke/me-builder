...
個別診断の回答と画面は[Phase 1 診断体験設計](../diagnosis/diagnosis-experience.md)、回答からパラメータを計算する方法と版管理は[診断回答のパラメータ変換設計](../diagnosis/scoring/parameter-scoring-design.md)、Source RecordとBrainの責務境界は[ドメイン設計](../domain/domain-design.md)を正とします。
