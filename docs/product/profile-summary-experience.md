...
最新版で再生成可能なときは、カードの左奥に「新しい私を見る」カードを一部だけ見せます。最新版を右へ十分にスワイプして離すと、現在のカードが右へ抜け、「新しい私」のカードがスタックへ加わるアニメーションの完了後に生成を要求します。生成中は追加されたカードを後ろに残し、最後に成功した版を引き続き閲覧できるようにします。診断の追加、日記・記録の追加、前回生成からの時間経過のうち該当する理由を、生成カード内に短く表示します。
