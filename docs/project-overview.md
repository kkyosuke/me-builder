...
回答を続けたくなる体験を検証します。入力体験は[§4](#4-想定する利用体験)、ログイン手段は[§5](#5-アカウントと本人識別)で確定しています。この段階では入力から蓄積までにAIを使わず、蓄積したデータと分身を構成する情報（Brain Item）の関係はPhase 2で設計します。
...
- 日記とアンケート回答を、分身を構成する情報（Brain Item）へどう対応づけるか
