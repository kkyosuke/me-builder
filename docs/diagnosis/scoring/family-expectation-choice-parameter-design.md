...
| `family-partnership-agreement` | 結婚の選択 | 自分の判断で進めたい | 家族の納得を待ちたい |
| `family-residence-priority` | 住む場所を選ぶ基準 | 自分の生活条件を優先したい | 家族との近さを優先したい |

どちらの側にも優劣を付けず、家族への愛情、家族関係の良し悪し、自立性、成熟度、意思決定能力は推定しません。結婚、転職、転居の予定や経験が実際にあることも推定しません。
...
Relationship Categoryは`family`とします。すべての質問が、回答時に思い浮かべた家族への相談や、家族の意向が関わる選択を前提にしているためです。特定の続柄、家族構成、同居、家族との近居、結婚の経験は固定しません。
