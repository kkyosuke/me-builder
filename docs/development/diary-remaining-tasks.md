...
- V2でエクスポートを提供した後は、保存した写真がその対象へ含まれることを確認する

完了条件は、[プロジェクト概要 §4](../product/project-overview.md#4-想定する利用体験)の入力形式「自由記述（写真を添えられる）」を満たすことです。写真を保存できるまでの間は、受け付けられないことを本人へ伝える暫定対応も許容します。エクスポートとの接続確認はV2の完了条件として扱い、MVPリリースを妨げません。
