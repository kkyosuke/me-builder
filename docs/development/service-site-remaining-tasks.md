...
### 3.2 問い合わせ・特定商取引法の開示窓口を稼働させる

- [サービス紹介サイト設計](../product/service-site-design.md#73-お問い合わせ)で確定した公開窓口を実際に受信できる宛先へ接続し、利用前の質問、不具合、課金、データ関連の請求、権利侵害を受け付ける
- [特定商取引法に基づく表記の設計](../product/service-site-design.md#74-特定商取引法に基づく表記)に従い、公開repository外の情報管理と購入前の開示請求を実際に処理できることを確認する
- 本人確認が必要な依頼を、公開フォームだけで完了させない手順を決める
- LINEトークは問い合わせ窓口に使わず、通常メッセージを日記として扱う現在の処理と混同させない
- 受付後の保存先、閲覧権限、返信方法、削除時期をプライバシーポリシーへ反映する
- 有効な窓口へ置き換えた後に`noindex,nofollow`を解除する

完了条件は、テスト送信へ実際に返信でき、住所・電話番号の開示請求へ購入判断前の十分な余裕をもって回答でき、機微情報を最初の連絡で要求せず、利用規約が参照する窓口として継続運用できることです。

### 3.3 料金と掲載機能の公開状態を確定する

- [サブスクリプション・料金プラン設計](../product/subscription-plan-design.md)で確定した商取引条件を、実装済みの購入・復旧手段と一致させる
- [特定商取引法に基づく表記の設計](../product/service-site-design.md#74-特定商取引法に基づく表記)で確定した販売業者名と適格請求書発行事業者の登録番号を、Stripeの領収書・請求書と公開表示へ反映し、初回課金前に課税区分を税務の専門家へ確認する
- Webの診断、LINEの日記、「わたしのまとめ」について、本番で利用できる対象者と制約を確認する
- 未提供の機能を「利用できます」と表示せず、実態に合わせて「準備中」または「構想中」へ分ける
- 公開時点の料金情報をFAQ、利用規約、プライバシーポリシー、特定商取引法に基づく表記へ反映する
