...
回答を削除する操作には確認を挟み、削除した質問を未回答として扱います。他の回答が残っていればアンケート全体は回答途中、残っていなければ未回答へ戻ります。回答状態とSource Recordとの関係は[Phase 1 アンケートドメイン設計](questionnaire-domain-design.md#7-surveyresponse-aggregate)を正とします。
