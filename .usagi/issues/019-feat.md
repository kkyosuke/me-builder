...
- 1つのAccountとSurveyの組み合わせにSurveyResponseは最大1件
- 1問の回答は1件のSource Recordとし、修正では新しいSource Recordと改訂関係を作る
- スキップはAnswerおよびSource RecordではなくSurveyResponseの進捗として記録する
...
- SurveyResponse更新とSource Record作成の一貫性、再送、競合制御
...
- [ ] 質問がサーバーから配信される
- [ ] 回答がSource Record、スキップがSurveyResponseの進捗として保存され、回答した時点の質問の版が残る
