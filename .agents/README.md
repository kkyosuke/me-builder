...
| [アンケート回答のパラメータ変換設計](../docs/parameter-scoring-design.md) | アンケート固有の設定形式、共通の計算手順、版管理、追加手順 |
| [「自分と相手の優先・境界線」パラメータ変換設計](../docs/relationship-priority-parameter-design.md) | 最初のアンケート固有の4パラメータ、質問ごとの重み、表示設定 |
| [「お金と消費」パラメータ変換設計](../docs/money-values-parameter-design.md) | 2つ目のアンケート固有の5パラメータ、質問ごとの重み、表示設定 |
