...
export function CompatibilityResultScreen({
  ...
  return (
    ...
    >
      ...
      {!progression && (
        <output className="mt-5 block rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900 dark:border-amber-900 dark:bg-amber-950/40 dark:text-amber-200">
          ふたりの歩みは一時的に表示できません。相性シートはそのまま確認できます。
        </output>
      )}
