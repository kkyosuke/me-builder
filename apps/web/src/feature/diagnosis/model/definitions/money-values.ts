...
/** 「お金と消費」10問のversion 1。 */
export const MONEY_VALUES_QUESTIONS: DiagnosisQuestion[] = [
  {
    diagnosisQuestionId: "dq-money-01",
  ...
  {
    diagnosisQuestionId: "dq-money-02",
  ...
  {
    diagnosisQuestionId: "dq-money-03",
  ...
  {
    diagnosisQuestionId: "dq-money-04",
  ...
  {
    diagnosisQuestionId: "dq-money-05",
  ...
  {
    diagnosisQuestionId: "dq-money-06",
  ...
  {
    diagnosisQuestionId: "dq-money-07",
  ...
  {
    diagnosisQuestionId: "dq-money-08",
  ...
  {
    diagnosisQuestionId: "dq-money-09",
  ...
  {
    diagnosisQuestionId: "dq-money-10",
...
export function scoreMoneyValues(interactions: DiagnosisInteraction[]): MoneyValuesProfile {
