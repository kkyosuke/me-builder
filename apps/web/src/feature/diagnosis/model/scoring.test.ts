...
import type { DiagnosisAnswer, DiagnosisQuestion } from "./types";
...
function answer(questionId: string, questionVersion: number, choiceId: string): DiagnosisAnswer {
  return {
    kind: "answer",
    diagnosisQuestionId: questionId.replace(/^q-/, "dq-"),
    questionId,
    questionVersion,
    choiceId,
    direction: "right",
