...
export function SurveyHome({
  ...
  surveys: AsyncState<SurveyListItem[]>;
  ...
  return (
    <main className="mx-auto min-h-dvh w-full max-w-2xl px-4 py-8 sm:px-8">
      ...
      <section aria-label="アンケート一覧" className="grid grid-cols-2 gap-3 sm:gap-4">
        ...
        {surveys.status === "loading" && (
          <LoadingState variant="panel" message="アンケートを読み込んでいます..." />
        )}
