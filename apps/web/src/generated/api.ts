...
export interface paths {
  ...
  "/api/avatar/jobs/{jobId}/generation": {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    get?: never;
    put?: never;
    /** 人物確認済み画像から候補生成を受け付ける */
    post: operations["startAvatarGeneration"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/api/avatar/jobs/{jobId}": {
    ...
    post?: never;
    /** 未確定のアバタージョブを中止する */
    delete: operations["cancelAvatarJob"];
    options?: never;
    head?: never;
    patch?: never;
    trace?: never;
  };
  "/api/avatar/images/{imageId}": {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
