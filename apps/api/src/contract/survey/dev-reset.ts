...
export const ResetDevelopmentSurveyDataResponseSchema = v.object({
...
export const resetDevelopmentSurveyDataRoute = describeRoute({
  operationId: "resetDevelopmentSurveyData",
  tags: ["Development"],
  summary: "開発環境で本人のアンケート回答データを全削除する",
  security: [{ liffIdToken: [] }],
  responses: {
    200: jsonResponse("削除した本人の回答関連データ件数", ResetDevelopmentSurveyDataResponseSchema),
    ...authenticatedErrors,
