...
- weekly_rhythmは、固定曜日ならscheduleModeをfixed_weeklyにし、勤務・可動曜日をactiveWeekdays、休みの曜日をdaysOffへstatementにある範囲だけ列挙する。土日休みもfixed_weeklyとして表す
- weekly_rhythmのvariable_shiftとirregularにはactiveWeekdaysとdaysOffを付けない
