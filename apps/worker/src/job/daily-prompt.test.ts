...
import { enqueueDailyPrompts, toTokyoLocalDate, toTokyoLocalHour } from "./daily-prompt";
...
describe("daily prompt scheduler job", () => {
  ...
  it("09:00 UTCを同日のAsia/Tokyo日付へ変換する", () => {
    ...
    expect(toTokyoLocalHour(new Date("2026-08-14T09:00:00.000Z").getTime())).toBe(18);
    expect(toTokyoLocalHour(new Date("2026-08-14T12:00:00.000Z").getTime())).toBe(21);
  });
