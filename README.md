...
ユーザーはテキストだけでなく、選択肢、写真、動画、音声などを使って質問に回答できます。将来は、蓄積した回答を本人が許可した範囲でMCPを通じてAIエージェントへ提供します。
...
本人が入力した診断回答と日記はWebで確認・訂正・削除でき、本人データはJSONでエクスポートできます。診断の自由記述・画像回答はV2で提供します。
